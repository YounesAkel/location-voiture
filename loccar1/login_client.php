...
<div id="container">
            ...
            <form action="client_reservation.php" method="post" class="formulaire" style="border-radius: 10px;">
                <h1>Client</h1>
               ...
               <a href="crer_compt_client.php" >creer un compt</a>
                 <?php 
  if(isset($_POST['btlogin'])){
$req="SELECT * from clients_login where login_client='".$_POST['txtlogin']."' and password_client='".$_POST['txtpw']."'"  ;
if($resultat=mysqli_query($cnloccar,$req)){
$ligne=mysqli_fetch_assoc($resultat);//tester la requete sur la table utilisateur
if($ligne!=0)
{
session_start();
$_SESSION['login_client']= $_POST['txtlogin'];
//echo "Bienvenue".$_SESSION['login'];
if(isset($_POST['check'])){
	setcookie('email', $_SESSION['login_client'], time() + 365*24*3600, null, null, false, true);//cette cookies sera expirer dans un ans
